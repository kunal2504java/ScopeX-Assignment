...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "h-full px-4 py-4 hidden md:flex md:flex-col bg-white dark:bg-zinc-950 w-[300px] flex-shrink-0 border-r border-slate-200 dark:border-zinc-800",
        className
      )}
      animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "h-10 px-4 py-4 flex flex-row md:hidden items-center justify-between bg-white dark:bg-zinc-950 w-full border-b border-slate-200 dark:border-zinc-800"
        )}
        {...props}
      >
